...
const audiences = [
  {
    ...
    description: "Bring your creative vision to life with AI-powered design tools",
    gradient: "from-pink-500 via-purple-500 to-indigo-500",
    icon: Palette
  },
  {
    title: "Students & Learners", 
    description: "Accelerate your learning with intelligent tutoring and research",
    gradient: "from-blue-500 via-cyan-500 to-teal-500",
    icon: Brain
  },
  {
    title: "Developers & Engineers",
    description: "Code faster with AI-assisted development and debugging",
    gradient: "from-green-500 via-emerald-500 to-teal-500", 
    icon: Code
  },
  {
    title: "Startups & Teams",
    description: "Scale your operations with unified creative intelligence",
    gradient: "from-orange-500 via-red-500 to-pink-500",
    icon: Users
  },
  {
    title: "Businesses",
    description: "Transform workflows with enterprise-grade AI solutions",
